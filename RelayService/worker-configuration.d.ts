/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=RelayService/wrangler.jsonc --env-file=/private/tmp/jr-types-vars --strict-vars=false RelayService/worker-configuration.d.ts` (hash: 79abd816cd63b128e45f3d01e41821fe)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "InstallationRelay" | "APNsProviderToken" | "ServiceAdmission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELAY_ENABLED" | "REGISTRATIONS_ENABLED" | "APNS_ENVIRONMENT" | "APNS_TEAM_ID" | "APNS_KEY_ID" | "APNS_TOPIC" | "APNS_PRIVATE_KEY" | "OPERATOR_TOKEN">> {}
}
