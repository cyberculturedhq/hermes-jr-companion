/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 4a833e5054970108d7e55421daa4847e)
...
interface __BaseEnv_Env {
	...
	SETUP_TICKET_PRIVATE_KEY: string;
	INSTALLATIONS: DurableObjectNamespace<import("./src/index").InstallationRelay>;
	ADMISSION: DurableObjectNamespace<import("./src/index").ServiceAdmission>;
	APNS_AUTH: DurableObjectNamespace<import("./src/index").APNsProviderToken>;
	SETUP_INTENTS: DurableObjectNamespace<import("./src/index").SetupIntent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "InstallationRelay" | "APNsProviderToken" | "ServiceAdmission" | "SetupIntent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELAY_ENABLED" | "REGISTRATIONS_ENABLED" | "APNS_ENVIRONMENT" | "APNS_TEAM_ID" | "APNS_KEY_ID" | "APNS_TOPIC" | "APNS_PRIVATE_KEY" | "OPERATOR_TOKEN" | "SETUP_TICKET_PRIVATE_KEY">> {}
}
